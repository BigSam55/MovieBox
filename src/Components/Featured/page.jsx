...
export default function Feature() {
  return (
    ...
    <div className={style.top}>
        <h1>Featured Movie</h1>  <button className={style.btn} > <p> See more </p>< IoIosArrowForward className={style.arrow}  /></button>
    </div>
    ...
    <SwiperSlide key={index}>
        ...
        <div className={style.mContent}>
          ...
          <div className={style.mImage}>
            <Image src={movie.poster} width={250} height={400} alt="movies" />
          </div>
